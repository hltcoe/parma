...
class NoTrainAligner(val feature: BinaryAlignmentSimilarity) extends InferenceEngine[NTFR] {
	...
	override def postTrainCalibrate(examples: Seq[DocAlignmentWithFeatures[NTFR]], loss: Seq[Instance[DocAlignment]] => Double) {}
	...
	override def align(fr: NTFR): DocAlignment = {
